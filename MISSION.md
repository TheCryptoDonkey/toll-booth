...
toll-booth is the foundation of a stack for machine-to-machine commerce. [satgate](https://github.com/TheCryptoDonkey/satgate) builds on it to monetise AI inference. [l402-mcp](https://github.com/TheCryptoDonkey/l402-mcp) gives AI agents the ability to discover and pay for toll-booth-protected APIs autonomously. Together, they close the loop: any API can charge, any agent can pay.
